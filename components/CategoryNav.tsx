...
const CATEGORIES = [
  ...
  { label: "Lịch", href: "/calendar", icon: CalendarDays, ready: true },
  { label: "Địa điểm", href: "/places", icon: MapPinned, ready: true },
  { label: "Random", href: "/random", icon: Shuffle, ready: true },
